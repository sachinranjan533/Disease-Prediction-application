...
def diabetes():
	if request.method=='GET':
		...
		return render_template("diabetesresult.html",y_pred=y_pred)
...
def heart():
	if request.method=='GET':
		...
		return render_template("heartresult.html",y_pred=y_pred)
...
def liver():
	if request.method=='GET':
		...
		y_pred=model.predict(new)
		return render_template('liverresult.html',y_pred=y_pred)
...
def kidney():
	if request.method=='GET':
		...
		y_pred=model.predict(new)
		return render_template('kidneyresult.html',y_pred=y_pred)
...
def tb():
	if request.method=="GET":
		...
		y_pred=model.predict(new)
		return render_template("tbresult.html",y_pred=y_pred)
